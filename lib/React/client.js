...
const withClient = (
  ...
  if (typeof document === "undefined") {
    ...
    debugSys.log('Hydrating UI');
    try {
      
      hydrateRoot(document.getElementById("root"), React.createElement(Fc, props));
      Fc.hydrated = true; //signeture of hydrated already
      clientSessions.isHydrated = true; //whether the client is hydrated

      debugSys.log('Hydration completed');
    }
    catch (e) {
      debugSys.error('Hydration Error:', e);
    }
